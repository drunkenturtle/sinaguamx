  ...
  render: function() {
    return (
     React.createElement("div", null, 
       React.createElement("input", {type: "text", value: this.state.untexto, placeholder: "escribe un texto", onChange: this.onChangeUntexto}), 
       React.createElement("button", {onClick: this.onClickMe}, "Click Me")
     )
    );
  }
});
