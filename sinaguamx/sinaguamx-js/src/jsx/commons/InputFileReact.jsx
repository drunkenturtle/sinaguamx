 ...
 *
 */
var InputFileReact = React.createClass({
    ...
    render: function() {
      ...
      if(this.state.fileSelected) {
        inputFile = (<input ref='inputFile' name={this.state.name} className='fileInput' type='file' onChange={this.handleFile} accept={fileExtensions}/>);

      } else {
        inputFile = (<input ref='inputFile' name={this.state.name} className='fileInput' type='file' onChange={this.handleFile} accept={fileExtensions} value=''/>);
      }
        ...
        <div className='inputFileReact'>
          <div className='fileInputGroup'>
            ...
            <div className='fileInputWraper'>
              <label htmlFor={this.state.name} className='customFileUpload'>
